        ...
        SELECT
            ...
            ROW_NUMBER() OVER (
                PARTITION BY 
                    ...
                    CASE 
                        WHEN m.medal IN ('green', 'red', 'diamond', 'gold', 'first_to_green') 
...
def gather_achievements(challenge_id):
    ...
    diamond_week = week_achievements.get("diamond", {})
    ...
    if (highest_tier_challenge_details or highest_tier_week) and (
        gold_week or first_to_green or green_week or red_week or diamond_week or all_gold or all_green
    ):
    ...
    if diamond_week:
        lines.append(
            render_achievement_line(":gem:", "Diamond Week", diamond_week)
        )
    ...
    # Add blank line between groups if both exist
    if (gold_week or first_to_green or green_week or red_week or diamond_week) and (earliest or latest):
        lines.append(None)  # Marker for blank line
